...
function separateWordsByCapitalLetters(inputString) {
  ...
  for (var i = 0; i < wordsArray.length; i++) {
    ...
    if(wordsArray[i].includes("a") && !(wordsArray[i].includes("on") || wordsArray[i].includes("of")) && wordsArray[i] != "Alpha" && wordsArray[i] != "Myopia" && wordsArray[i] != "Kotobukiya" && wordsArray[i] != "Necrosha" && wordsArray[i] != "Insignia" && wordsArray[i] != "Ninja" && wordsArray[i] != "Aura" && wordsArray[i] != "Extra"){
